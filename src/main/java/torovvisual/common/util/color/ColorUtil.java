package torovvisual.common.util.color;
...
public class ColorUtil {
    ...
    public Vector4i roundClientColor(float alpha) {
        return new Vector4i(ColorUtil.multAlpha(ColorUtil.fade(270), alpha), ColorUtil.multAlpha(ColorUtil.fade(0), alpha),
                ColorUtil.multAlpha(ColorUtil.fade(180), alpha), ColorUtil.multAlpha(ColorUtil.fade(90), alpha));
    }
    ...
    @lombok.Setter
    private int clientColor = 0xFF6C9AFD;
