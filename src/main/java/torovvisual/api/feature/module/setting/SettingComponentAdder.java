package torovvisual.api.feature.module.setting;

import torovvisual.api.feature.module.setting.implement.*;
import torovvisual.implement.screens.menu.components.implement.settings.*;
import torovvisual.implement.screens.menu.components.implement.settings.multiselect.MultiSelectComponent;
import torovvisual.implement.screens.menu.components.implement.settings.select.SelectComponent;
    ...
    public void addSettingComponent(List<Setting> settings, List<AbstractSettingComponent> components) {
        settings.forEach(setting -> {
            ...
            if (setting instanceof ValueSetting valueSetting) {
                components.add(new StepperComponent(valueSetting));
            }
