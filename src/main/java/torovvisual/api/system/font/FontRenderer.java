...
import torovvisual.api.system.font.entry.DrawEntry;
import torovvisual.api.system.font.glyph.Glyph;
import torovvisual.api.system.font.glyph.GlyphMap;
...
public class FontRenderer implements QuickImports {
    ...
    public static @NotNull Identifier randomIdentifier() {
        return Identifier.of("torovvisual", "temp/" + StringUtil.randomString(32));
    }
