...
import torovvisual.api.feature.module.setting.implement.GroupSetting;
import torovvisual.api.system.font.Fonts;
import torovvisual.common.util.other.StringUtil;
import torovvisual.implement.screens.menu.components.implement.other.CheckComponent;
import torovvisual.implement.screens.menu.components.implement.other.SettingComponent;
import torovvisual.implement.screens.menu.components.implement.window.AbstractWindow;
import torovvisual.implement.screens.menu.components.implement.window.implement.settings.group.GroupWindow;
