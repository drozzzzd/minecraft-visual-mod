...
import torovvisual.implement.screens.menu.components.implement.window.implement.settings.color.ColorWindow;

import static torovvisual.api.system.font.Fonts.Type.*;
